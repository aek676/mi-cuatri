...
public static class MockFactory
{
    ...
    )
    {
        ...
        mock.Setup(t => t.Protect(It.IsAny<string>()))
            .Returns(
                (string input) => string.IsNullOrEmpty(input) ? string.Empty : $"protected_{input}"
            );

        mock.Setup(t => t.Unprotect(It.IsAny<string>()))
            .Returns(
                (string input) =>
                {
    ...
    )
    {
        ...
        mock.Setup(r => r.UpsertByUsernameAsync(It.IsAny<string>(), It.IsAny<string>()))
            .Returns(Task.CompletedTask);

        mock.Setup(r => r.AddEventAsync(It.IsAny<string>(), It.IsAny<Event>()))
            .ReturnsAsync((string username, Event evt) => evt);

        mock.Setup(r => r.UpdateEventAsync(It.IsAny<string>(), It.IsAny<Event>()))
            .ReturnsAsync(true);

        mock.Setup(r => r.DeleteEventAsync(It.IsAny<string>(), It.IsAny<string>()))
            .Returns(Task.CompletedTask);
    ...
    )
    {
        ...
        mock.Setup(s => s.AuthenticateAsync(It.IsAny<string>(), It.IsAny<string>()))
            .ReturnsAsync(
